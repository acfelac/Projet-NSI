...
def update_pipes():
    ...
    for pipe_info in pipes:
        ...
        if pipe_info['x'] < -100:
            ...
            score += 1
        # Vérifier si le tuyau touche l'oiseau
        if pipe_info['x'] == bird_x and (bird_y < pipe_info['top_height'] or bird_y + BIRD_SIZE > SCREEN_HEIGHT - pipe_info['bottom_height']):
...
while True:
    ...
    # Mettre à jour la vitesse et la position de l'oiseau
    bird_speed += GRAVITY
    bird_y += bird_speed
